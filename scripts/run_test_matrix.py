            ...
            if combo["pruning"] == "none":
                if ablation_step is not None:
                    ...
                    step_descriptions = {
                        ...
                        "V0": "RA baseline: Standard GPT-2 SDPA (1.33ms)",
                        "V1": "RA: Folded layout, learned gates, R=4 (1.33ms)",
                        "V2": "RA + Self-Restart: V1 + identity path (1-α)attn+αV",
                        "V3": "RA + R-MLP: Basic folded MLP (R_ff=64)",
                        "V4": "RA + R-MLP + Mixer: 1x1 linear on h_low",
                        "V5": "RA + R-MLP + Gates: Per-token discoverability",
                        "V6": "RA + R-MLP + Mixer + Gates: All mechanisms",
