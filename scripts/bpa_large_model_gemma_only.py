#!/usr/bin/env python3
# BPA Large Model Validation: Gemma-2-27B-IT only
#
# Reuses the RunPod harness from bpa_large_model_gemma_llama.py
# but targets only google/gemma-2-27b-it (v3 plan).
#
# Usage:
#     source ~/.enhance-bash && source ~/envs/runpod/bin/activate
#     python3 scripts/bpa_large_model_gemma_only.py
...
def main():
    ...
    # Save combined
    combined_path = f"{JSON_DIR}/large_model_gemma_only.json"
