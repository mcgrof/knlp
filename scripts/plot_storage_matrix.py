...
Usage:
  python scripts/plot_storage_matrix.py \\
      --results /data/results-archive/lmcache_nvme_storage_matrix_20260430/storage_matrix_results.json \\
      --out plots/
"""
...
def main():
    ...
    ap.add_argument(
        "--results",
        default="/data/results-archive/lmcache_nvme_storage_matrix_20260430"
