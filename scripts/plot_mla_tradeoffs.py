...
ax1.set_ylabel(
    "Validation Perplexity (lower is better)", fontsize=11, fontweight="bold"
)
...
fig1.suptitle(
    "Primary Trade-off: GPT-2 Baseline vs MLA (GPT-2 124M, FineWebEdu)",
    fontsize=14,
    fontweight="bold",
    y=1.00,
)
...
conclusion1 = (
    "MLA achieves 6x cache compression (36→12 MB) at cost of 50% more training time (2.0→3.0 hours).\n"
...
fig2.suptitle(
    "Secondary Trade-off: MLA vs MLA+KVSplice (GPT-2 124M, FineWebEdu)",
    fontsize=14,
    fontweight="bold",
    y=1.00,
)
...
conclusion2 = (
    "KVSplice doubles compression (12→6 MB) at cost of 27% more training time (3.0→3.8 hours).\n"
...
ax.set_ylabel(
    "Time×Memory Burden (MB·min, lower is better)", fontsize=12, fontweight="bold"
)
ax.set_title(
    "Overall Resource Efficiency: Training Time × KV Cache Memory",
    fontsize=13,
    fontweight="bold",
)
...
fig3.suptitle(
    "Best Overall Efficiency Despite Slower Training (GPT-2 124M, FineWebEdu)",
    fontsize=14,
    fontweight="bold",
    y=0.98,
)
...
conclusion3 = (
    "MLAKV0 achieves lowest time×memory burden (32% of baseline) despite 90% longer training.\n"
