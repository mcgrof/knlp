...
KEYS = {
    ...
    "CONFIG_CARTRIDGES_CAS_PHASE_TRAINING_SPREAD": (
        "phase_training_spread",
        bool,
    ),
    ...
    "CONFIG_CARTRIDGES_CAS_PAPER_EVAL_CAPS": ("paper_eval_caps", str),
    "CONFIG_CARTRIDGES_CAS_PAPER_FULLDOC_CONTROL": (
        "paper_fulldoc_control",
        bool,
    ),
    "CONFIG_CARTRIDGES_CAS_SPREAD_PATIENT": ("spread_patient", str),
    "CONFIG_CARTRIDGES_CAS_SPREAD_SEEDS": ("spread_seeds", str),
    "CONFIG_CARTRIDGES_CAS_SPREAD_GPUS": ("spread_gpus", str),
    "CONFIG_CARTRIDGES_CAS_SPREAD_EVAL_RUNS": ("spread_eval_runs", int),
    "CONFIG_CARTRIDGES_CAS_SPREAD_SAVE_EVERY": ("spread_save_every", int),
