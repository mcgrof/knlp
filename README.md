...
- **[Key Test Results Archive](https://github.com/mcgrof/results-archive)**: Complete test matrix results with all graphs and metrics
  - [R-MLP Validation (Nov 2025)](https://github.com/mcgrof/results-archive/tree/master/key_results/test_matrix_results_20251111_170325/FINDINGS.md): **12% improvement** over baseline GPT-2, reciprocal weights learned positive
