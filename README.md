...
| **Reciprocal Attention** | Closed research line. A GPT-2 small-scale FineWebEdu comparison measured **5% better PPL** (72.5 → 68.9) and **+2 HellaSwag**; matched 1B runs were neutral, and a preregistered 3-seed matched training matrix found no RA variant beating paired baselines — the [evidence page](docs/ra-evidence.md) carries the full record and the mechanistic explanation. | [docs](docs/ra.md) · [evidence](docs/ra-evidence.md) | [demo](https://mcgrof.github.io/knlp/ra_visualization.html) |
