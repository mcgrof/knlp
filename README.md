...
| **Reciprocal Attention** | Learned Q@K.T ↔ K@Q.T mixing. In a GPT-2 small-scale FineWebEdu comparison: **5% better PPL** (72.5 → 68.9), **+2 HellaSwag**, beating an SDPA-gate control. Matched 1B runs were neutral within noise; scaling unproven. | [docs](docs/ra.md) · [evidence](docs/ra-evidence.md) | [demo](https://mcgrof.github.io/knlp/ra_visualization.html) |
