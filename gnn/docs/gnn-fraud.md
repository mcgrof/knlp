...
[Interactive Visualization](../../docs/gnn_fraud_visualization.html) ·
...
- `benchmark_fim.py` — Main benchmark script
- `fim_sampler.py` — FIM-guided sampler
- `fim_importance.py` — Backward hook importance tracking
- `page_batch_sampler.py` — C++ accelerated page-aware sampler
