...
def create_argument_parser():
    ...
    parser.add_argument("--max-time", type=int, default=0, help="Maximum training time in seconds (0=no limit)")
    ...
    parser.add_argument("--decay-lr", action="store_true", default=True, help="Use LR decay")
    ...
    parser.add_argument("--target-sparsity", type=float, default=0.5, help="Target sparsity")
    parser.add_argument("--pruning-warmup", type=int, default=1000, help="Pruning warmup steps")

    # SPAM optimizer config
    parser.add_argument("--spam-theta", type=float, default=50.0, help="SPAM theta")
    parser.add_argument("--spam-interval", type=int, default=1000, help="SPAM reset interval")
    parser.add_argument("--spam-warmup-steps", type=int, default=1000, help="SPAM warmup steps")

    # AdamWPrune config
    parser.add_argument("--adamwprune-variant", type=str, default="bitter0", help="AdamWPrune variant")

    # Logging and evaluation
    parser.add_argument("--log-interval", type=int, default=10, help="Logging interval")
    parser.add_argument("--eval-interval", type=int, default=100, help="Evaluation interval")
    parser.add_argument("--eval-samples", type=int, default=200, help="Evaluation samples")
    ...
    # Tracking
    parser.add_argument("--tracker", type=str, default="none", help="Experiment tracker (none, trackio, wandb)")
    parser.add_argument("--tracker-project", type=str, default="", help="Tracker project name")
    parser.add_argument("--tracker-run-name", type=str, default="", help="Tracker run name")

    # DDP
    parser.add_argument("--ddp-find-unused-params", action="store_true", default=True, help="DDP find unused params")
